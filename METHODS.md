...
Finally, the model corrects for low ranked teams, under the 25th percentile, that mostly play low ranked teams, under the 25th percentile. The purpose of this correction is to not reward these teams unfairly with too low defensive metrics, that would inevitably result from low weighting of the scores of the low ranked opponents. A similar correction might be needed for mid tier teams, that mostly play mid tier teams. These teams might get an unfairly low defensive score, compared to higher ranked teams, because goals scored by other mid tier teams are weighted too low. This might be the reason why teams like Mali, who have not qualified to the World Cup, and played other high ranked teams besides Morocco, gets such a good ranking. But this correction is less necessary with mid tier teams, just as long as they get to play top ranked teams. And just as long as these teams do not play top ranked teams, it is hard to know how well they would perform. It is therefore important to always read the rankings and predictions in light of the underlying historical match data for each team.