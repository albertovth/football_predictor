...
- `pipeline/spi_stage2/` remains the production formula and simulation engine;
  ...
  reused.
- `pipeline/spi_stage3/` adds match-count evidence weighting without
  reimplementing the Stage 2 adjusted-goal formulas. The full replay applies a
  dated four-year confidence window at both later handoffs.
